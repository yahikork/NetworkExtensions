                ...
                case NetInfoVersion.Ground:
                    ...
                    for (int i = 0; i < info.m_nodes.Count(); i++)
                    {
                        ...
                        else if (info.m_nodes[i].m_flagsRequired == NetNode.Flags.Transition)
                        {
                            info.m_nodes[i].SetTextures(
                                new TextureSet
                                    (@"Roads\TinyRoads\Oneway1LParkingBicycle\Textures\Ground_Trans__MainTex.png",
                                     @"Roads\TinyRoads\Oneway1LParkingBicycle\Textures\Ground_Trans__APRMap.png"),
                                new LODTextureSet(
                                    @"Roads\TinyRoads\Oneway1LParkingBicycle\Textures\Ground_Trans_LOD__MainTex.png",
                                    @"Roads\TinyRoads\Oneway1LParkingBicycle\Textures\Ground_Trans_LOD__APRMap.png",
                                    @"Roads\TinyRoads\Oneway1LParkingBicycle\Textures\Ground_LOD__XYSMap.png"));
                        }
                    }
                    break;
